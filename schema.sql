-- EthioLiveScores Database Schema
...
WITH match_results AS (
    ...
    SUM(away_score) AS goals_for, SUM(home_score) AS goals_against,
...
FROM match_results r JOIN teams t ON r.team_id = t.id GROUP BY t.id, t.name_en, t.name_am ORDER BY pts DESC, gd DESC;
